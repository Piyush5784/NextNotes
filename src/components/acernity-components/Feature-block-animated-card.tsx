...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "max-w-sm w-full mx-auto p-8 rounded-xl border border-primary dark:bg-gradient-to-r from-purple-400 to-violet-700 bg-gray-100 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
        className
      )}
    >
      {children}
...
export const CardDescription = ({
  ...
  return (
    <p
      className={cn(
        "text-sm font-normal text-neutral-600 dark:text-white max-w-sm",
        className
      )}
    >
      {children}
  ...
  return (
    <div
      className={cn(
        ...
        className,
        showGradient &&
          "bg-neutral-300 dark:bg-[rgba(255,255,255,0.7)] [mask-image:radial-gradient(50%_50%_at_50%_50%,white_0%,transparent_100%)]"
      )}
    >
      {children}
    </div>
