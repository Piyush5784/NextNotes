  ...
  return (
    <div className="flex items-center justify-center w-full h-full bg-transparent overflow-hidden">
      <div className="sparkle-button relative">
        <Button
          className="relative text-2xl py-3 px-5 rounded-full flex items-center gap-1 whitespace-nowrap transition-all duration-250 cursor-pointer"
          onMouseEnter={() => setIsActive(true)}
          onMouseLeave={() => setIsActive(false)}
          size={size as "default" | "lg" | "sm" | "icon"}
          variant={
            variant as
              | "link"
              | "default"
