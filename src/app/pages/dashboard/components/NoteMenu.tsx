...
const NoteMenu = ({ noteId }: { noteId: number }) => {
  return (
    <div className="relative inline-block dark:text-black">
      <DropdownMenu>
        <DropdownMenuTrigger className="flex items-center justify-center w-10 h-10 rounded-full hover:text-black hover:bg-gray-100 transition duration-200">
          <EllipsisVertical />
        </DropdownMenuTrigger>
        <DropdownMenuContent asChild>
          <motion.div
            ...
            className="bg-white text-black rounded-lg shadow-lg p-2 min-w-[100px] z-10"
          >
